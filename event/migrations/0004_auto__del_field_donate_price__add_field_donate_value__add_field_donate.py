...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Donate.price'
        db.delete_column(u'event_donate', 'price')

        # Adding field 'Donate.value'
        db.add_column(u'event_donate', 'value',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Donate.is_success'
        db.add_column(u'event_donate', 'is_success',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Donate.price'
        raise RuntimeError("Cannot reverse this migration. 'Donate.price' and its values cannot be restored.")
        # Deleting field 'Donate.value'
        db.delete_column(u'event_donate', 'value')

        # Deleting field 'Donate.is_success'
        db.delete_column(u'event_donate', 'is_success')
