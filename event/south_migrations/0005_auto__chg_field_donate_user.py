...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Donate.user'
        db.alter_column(u'event_donate', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Member'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Donate.user'
        raise RuntimeError("Cannot reverse this migration. 'Donate.user' and its values cannot be restored.")
