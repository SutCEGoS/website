...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Objection.term'
        db.add_column(u'objection_objection', 'term',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Objection.year'
        db.add_column(u'objection_objection', 'year',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['base.EducationalYear']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Objection.term'
        db.delete_column(u'objection_objection', 'term')

        # Deleting field 'Objection.year'
        db.delete_column(u'objection_objection', 'year_id')
