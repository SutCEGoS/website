...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.username'
        db.add_column(u'poll_vote', 'username',
                      self.gf('django.db.models.fields.CharField')(max_length=63, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Vote.comment'
        db.add_column(u'poll_vote', 'comment',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.username'
        db.delete_column(u'poll_vote', 'username')

        # Deleting field 'Vote.comment'
        db.delete_column(u'poll_vote', 'comment')
    ...
    models = {
        ...
        u'poll.vote': {
            'Meta': {'unique_together': "(('member', 'choice'),)", 'object_name': 'Vote'},
            ...
            'username': ('django.db.models.fields.CharField', [], {'max_length': '63', 'null': 'True', 'blank': 'True'})
        }
    }
