...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Vote', fields ['member', 'choice']
        db.create_unique(u'poll_vote', ['member_id', 'choice_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Vote', fields ['member', 'choice']
        db.delete_unique(u'poll_vote', ['member_id', 'choice_id'])
