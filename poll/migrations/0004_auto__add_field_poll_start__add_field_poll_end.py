...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.start'
        db.add_column(u'poll_poll', 'start',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Poll.end'
        db.add_column(u'poll_poll', 'end',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.start'
        db.delete_column(u'poll_poll', 'start')

        # Deleting field 'Poll.end'
        db.delete_column(u'poll_poll', 'end')
