...
class Calverter:
    ...
    def gregorian_to_jd(self, year, month, day):
        ...
        e.g. gregorian_to_jd(2013,22,4) return 2456936.5
        :type year: int
        :type month: int
        :type day: int
        :rtype:float
    ...
    def jd_to_gregorian(self, jd):
        ...
        jd_to_gregorian(2456404.5) return (2013, 4, 22)
        :type jd: float
        :rtype:tuple
        """
    ...
    def islamic_to_jd(self, year, month, day):
        ...
        e.g. islamic_to_jd(1434,6,11) return 2456404.5
        :type year:int
        :type month: int
        :type day: int
        :rtype float
    ...
    def jd_to_islamic(self, jd):
        ...
        e.g. jd_to_islamic(2456404.5) return (1434, 6, 11)
    ...
    def jalali_to_jd(self, year, month, day):
        ...
        e.g. jalali_to_jd(1392,2,2) return 2456404.5
    ...
    def jd_to_jalali(self, jd):
        ...
        JD_TO_JALALI: Calculate Jalali date from Julian day
         e.g. jd_to_jalali(2456404.5) return (1392, 2, 2)
        :type jd:float
        :rtype:tuple
